...
<body>
	...
	<script>
			...
			var theData1 = <?php $url='https://docs.google.com/spreadsheets/d/e/2PACX-1vR_5UI4-5ToL9L5bcGTWDSs9X23olkWKfTr3dzrRWiP07tzql6hCmG-nJoN-J-zSfj8Ft_DWXlVQF5d/pub?gid=1523970292&single=true&output=csv';
			...
			var upcomingDates = "<strong>Former Dates:<br><br></strong>"+parseData(theData1);
			document.getElementById("display").innerHTML = upcomingDates;
	</script>
</body>
</html>